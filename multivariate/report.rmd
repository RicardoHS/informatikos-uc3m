...
Now we are going to perform a model-based approach. First, we need to compute the BIC.
...
The best possible model is the VVE with 4 components. This model correspond to the `ellipsoidal, equal orientation`. We can automatically compute it.
