...
outliers_index_robust <- sort_index_robust[which(p_values_robust[sort_index_robust] < ((1:n)/n*0.01))]

head(poke_long[outliers_index, ])
print(paste("Outlier Pokemon:", unique(poke_long[outliers_index,]$Name)))
```
